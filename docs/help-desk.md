...
![Pantalla de inicio de sesión de Shifton](img/shifton-login.png)
...
![Vista del Dashboard con turnos personales](img/shifton-vista-dashboard.png)
...
![Vista del Schedule mostrando turnos abiertos y filas de empleados](img/shifton-vista-horario.png)
...
2. En la fila de **"Open Shifts"**, haz clic en el turno que quieras tomar (ej. "13:00 - 14:00" del martes). Aparecerá un tooltip con el nombre del turno.
    ...
    ![Clic en un turno abierto disponible](img/shifton-turno-abierto-clic.png)

3. Se abrirá un panel lateral con el botón **"Take this shift"**. Haz clic en él para confirmar.

    ![Panel de confirmación con botón "Take this shift"](img/shifton-confirmar-turno.png)

4. El turno desaparecerá de la fila de turnos abiertos y aparecerá en **tu fila personal** del calendario.

    ![Turno tomado visible en la fila personal del empleado](img/shifton-turno-tomado.png)
...
1. En tu fila personal del calendario, haz clic en los **tres puntos** (⋮) que aparecen al lado del turno que quieres soltar. Selecciona **"Edit"**.
    ...
    ![Botón de tres puntos y opción Edit en un turno asignado](img/shifton-boton-editar-turno.png)

2. Se abrirá un panel lateral con varias opciones. En la sección **"MOVE TO OPEN SHIFTS"**, haz clic en el botón **"Move"**.

    ![Panel de acciones mostrando el botón Move para enviar a turnos abiertos](img/shifton-menu-turno-asignado.png)
...
3. Aparecerá un diálogo de confirmación: "Do you want to send this shift to the list of available shifts?". Haz clic en **"Yes, I confirm"**.
    ...
    ![Diálogo de confirmación para mover turno a turnos abiertos](img/shifton-confirmacion-solicitud-mover-turno.png)
...
4. Marca con el checkbox el turno de tu compañero/a que quieres recibir a cambio, y haz clic en **"Initiate swap"**.
    ...
    ![Sección de intercambio mostrando turnos disponibles y botón Initiate swap](img/shifton-opcion-swap.png)
...
1. En el Help Desk, haz clic en tu **foto de perfil** en la esquina inferior izquierda para acceder a **"My Profile"**.
    ...
    ![Acceder al perfil desde la esquina inferior izquierda](img/Helpdesk-seleccionar-perfil.png)

2. En tu perfil, haz clic en **"Edit availability"** en la sección "My Availability".

    ![Botón "Edit availability" en el perfil](img/Helpdes-editar-disponibilidad.png)
...
4. Cuando hayas ingresado todos tus horarios, haz clic en **"Done editing"** para guardar los cambios.
    ...
    ![Botón "Done editing" para guardar la disponibilidad](img/Helpdesk-seleccionar-done-editing.png)
